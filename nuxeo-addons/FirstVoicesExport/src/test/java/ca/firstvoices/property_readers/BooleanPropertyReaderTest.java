...
@LocalDeploy( {
        ...
        "FirstVoicesExport:OSGI-INF/extensions/ca.firstvoices.fake-load-actions.xml"
//        "FirstVoicesExport:OSGI-INF/extensions/ca.firstvoices.fake-load-es-provider.xml",
//        "FirstVoicesExport:OSGI-INF/extensions/ca.firstvoices.fake-directory-sql-contrib.xml"
} )
...
public class BooleanPropertyReaderTest
{
    ...
    public void testBooleanProp()
    {
        ...
        for (DocumentModel word : docArray)
        {
            ...
            String sbv2 = (String) db1.getReadProperty();
            assertTrue("Boolean value should be set to true", sbv1.equals("false"));
        }
    }
}