...
class AlphabetGridListTile extends Component {
    ...
    render() {
        return <GridListTile key={selectn('uid', this.props.tile)} style={{
            ...
            <span
                style={{fontSize: '2em'}}>{selectn('properties.fvcharacter:upper_case_character', this.props.tile)} {selectn('properties.dc:title', this.props.tile)}</span><br/><br/>
            <strong
            ...
            return <PromiseWrapper renderOnError={true} computeEntities={computeEntities}>
                ...
                <div className="row">
                    <div className={classNames('col-xs-8', 'col-xs-offset-2')}>
                        <h1>{intl.trans('views.pages.explore.dialect.learn.alphabet.x_alphabet',
                                        ...
                                        <Paper key={char.uid} style={{
                                            ...
                                            <Button variant='flat'
                                                ...
                                                style={{minWidth: 'inherit', textTransform: 'initial'}}>
                                                    {char.contextParameters.character.related_audio[0] && ((selectn('contextParameters.character.related_audio[0].path', char)) ? <PlayArrowIcon className="material-icons" /> : '')}
                                                    {char.title}
                                                </Button>
