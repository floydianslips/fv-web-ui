...
export default class PageDialectContributorsCreate extends Component {
    ...
    render() {
        ...
        return <div>
            ...
            <h1>{intl.trans('views.pages.explore.dialect.contributors.add_new_contributor_to_x',
                'Add New Contributor to ' + dialect.get('dc:title'), null, [dialect.get('dc:title')])}</h1>
