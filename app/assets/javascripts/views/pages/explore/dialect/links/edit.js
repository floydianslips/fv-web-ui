...
export default class Edit extends Component {
    ...
    render() {
        ...
        if (selectn("response", computeDialect2) && selectn("response", computeLink)) {
            let providedFilter = selectn("response.properties.fv-link:definitions[0].translation", computeLink) || selectn("response.properties.fv:literal_translation[0].translation", computeLink);
        ...
        return <div>
            ...
            <h1>{intl.trans('views.pages.explore.dialect.links.edit_x_link', 'Edit ' + selectn("response.properties.dc:title", computeLink) + ' Link', 'first', [selectn("response.properties.dc:title", computeLink)])}</h1>
