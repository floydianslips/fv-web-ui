            ...
            <div>
                <div className={'row'} style={{margin: '0'}}>
                    <div className={'col-lg-4'} style={{paddingLeft: '0'}}>
                        <Doughnut data={lifecycleStateDoughnutData} width="200" height="170"
                    ...
                    <div className={'col-lg-5'} style={{paddingTop: '65px'}}>
                        <ul>
                            <li>
                                <strong>{intl.trans('views.components.dashboard.created_today', 'Created Today', 'first')}: </strong>{dataResponse[docType].created_today}
                            </li>
                            <li>
                                <strong>{intl.trans('views.components.dashboard.modified_today', 'Modified Today', 'first')}: </strong>{dataResponse[docType].modified_today}
                            </li>
                            <li>
                                <strong>{intl.trans('views.components.dashboard.created_last_7_days', 'Created Last 7 Days', 'words')}: </strong>{dataResponse[docType].created_within_7_days}
                            </li>
                            <li>
                                <strong>{intl.trans('views.components.dashboard.available_in_kids_area', 'Available In Kids Area', 'words')}: </strong>{dataResponse[docType].available_in_childrens_archive}
                            </li>
                        </ul>
                    </div>
                </div>
